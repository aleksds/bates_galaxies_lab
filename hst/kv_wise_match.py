...
for i in range(0, len(galaxies)):
    ...
    print(galaxies[i],'w1_mag',w1_mag,'w1_mag_err',w1_mag_err,'w2_mag', w2_mag,'w2_mag_err',w2_mag_err,
          'w3_mag',w3_mag,'w3_mag_err',w3_mag_err,'w4_mag',w4_mag,'w4_mag_err',w4_mag_err)
