...
re_hi_arc = np.array([0.727, 0.883, 0.434, 0.575, 1.048, 1.392, 0.392, 0.610, 2.483, 6.386, 1.057, 0.949]) * 0.025 * u.arcsec
re_lo_arc = np.array([0.476, 0.584, 0.400, 0.346, 0.465, 0.904, 0.568, 0.392, 0.959, 4.048, 0.628, 0.003]) * 0.025 * u.arcsec
re_best_arc = np.array([0.610, 0.697, 0.424, 0.394, 0.650, 1.187, 0.549, 0.469, 1.385, 5.310, 0.918, 0.509]) * 0.025 * u.arcsec
