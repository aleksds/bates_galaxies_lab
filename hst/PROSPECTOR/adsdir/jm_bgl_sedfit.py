...
run jm_bgl_sedfit.py --nproc=4 --priors='delayed-tau' --galaxy='J0901' --sedfit  --verbose
run jm_bgl_sedfit.py --nproc=4 --priors='delayed-tau' --galaxy='J0901' --qaplots --verbose
...
def main():
    ...
    hfile = os.path.join(j2118dir, '{}-{}.h5'.format(args.galaxy, args.priors))
    ...
    if args.qaplots:
        ...
        png = os.path.join(j2118dir, '{}-{}-sed.png'.format(args.galaxy, args.priors))
