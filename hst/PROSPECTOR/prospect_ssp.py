...
with PdfPages(run_params['outfile']+'total.pdf') as pdf:
    for i in range(startindex,endindex):
        ...
        theta_truth = np.array([run_params[i] 
                                for i in ['mass','tage','dust2']])#['mass','logzsol','tau','tage','dust2']])
        ...
        cornerfig = pread.subtriangle(res, outname = run_params['outfile']+obs['objid'][i], start=0, thin=5, truths=theta_truth, fig=plt.subplots(3,3,figsize=(27,27))[0])
