...
for i in range(12):
    for j in range(14):
        if j == 0:
            ...
            tmp[i,j] = jc_values['re'][i] + re_array[j-1]
print(tmp)
...
for i in range(12):
    for j in range(14):
        if j == 0:
            ...
            md1f[i,j] = mag_values['m475'][i] + re_array[j-1]
            md2f[i,j] = mag_values['m814'][i] + re_array[j-1]
print(md1f)
                ...
                for q in range(0,13):
                    ...
                    if model == 'psf':
                        ...
                        if i==0:
                            ...
                            text.write(' 3) '+str(md1f[w][j]/2)+'     1/n')
                        if i==1:
                            mag = mag_values[w][2] #the m814 values
                            text.write(' 3) '+str(md2f[w][j]/2)+'     1\n')
