...
"""Input_creator_V5.py: V5 means Variation 5. Varition 5: This code automates
the creation and running of galfit input files. This final version is capable
of producing both independent and simultaneous file that are sersic solely.
This code can also handle coarse and fine pixels all in the s_index of coarse.
This is the final """
            ...
            for j in range(0,nmag):
                ...
                for q in range(0,nre):
                    ...
                    if constraint == 's_index':
                        text.write('G) /Volumes/physics/linux-lab/data/sersic\
                    ...
                    if model == 'sersic':
                        ...
                        +togetherness+'_'+imgsize+'_psf'+psf+'/'+'parameters\
                        _constraints_'+filters2[i]+'_'+str([j])+'_'+str([q])+\
                        '_'+galaxies[w]+'.txt'
                        ...
                        text.write('P) 0\n') #will not change
                        text.write('W) input,sigma,psf,component,model,\
                        residual\n')
...
#SIMULTANEOUS FITS OF VARYING DEGREE
    ...
    for w in range(0,ngal):
        ...
        for q in range(0,nre):
            ...
            '_drc_sci.fits,/Volumes/physics/linux-lab/data/hst/'+longgal[w]+\
            ...
            text.write('D) /Volumes/physics/linux-lab/data/hst/'+longgal[w]+\
            '/'+psf+'/'+filters[1]+'/final_psf.fits,/Volumes/physics/linux-\
            lab/data/hst/'+longgal[w]+'/'+psf+'/'+filters[0]+'/final_psf.fits\
            ,/Volumes/physics/linux-lab/data/hst/'+longgal[w]+'/'+psf+'/'\
