    ...
    for w in range(0,12):
        for i in range (0,2): # for i in range(0,2):
            for j in range(0,13):
                ...
                text.write('#  Chi^2/nu = ,  Chi^2 = ,  Ndof = \n') #probably not essential
                text.write('# IMAGE and GALFIT CONTROL PARAMETERS\n') #will not change , probably not essential
                text.write('A) /Users/adiamond/physics/linux-lab/data/hst/'+longgal[w]+'/fine/'+filters[1]+'/final_'+filters[1]+'_drc_sci.fits,/Users/Users/adiamond/physics/linux-lab/data/hst/'+longgal[w]+'/fine/'+filters[0]+'/final_'+filters[0]+'_drc_sci.fits\n')
                text.write('A1) V,U\n')
                text.write('A2) 814.000,475.000\n')
                text.write('B) '+galaxies[w]+'_F814W_F475W_'+model+'_output.fits\n')
                text.write('C) none,none      0.000\n')
                text.write('D) /Users/adiamond/physics/linux-lab/data/hst/'+longgal[w]+'/'+psf+'/'+filters[1]+'/final_psf.fits,/Users/Users/adiamond/physics/linux-lab/data/hst/'+longgal[w]+'/'+psf+'/'+filters[0]+'/final_psf.fits\n')
                text.write('E) 1\n')
