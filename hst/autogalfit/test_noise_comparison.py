...
with PdfPages(name) as pdf:
    ...
    for i in range(0, len(files)):
        ...
        plt.colorbar()
        plt.title('J2140_' + 'pixnoise_' + 'F475W (maybe)')
        pdf.savefig()
        plt.close()
        ...
        plt.colorbar()
        plt.title('J2140_' + 'pixnoise_' + 'F814W (maybe)')
        pdf.savefig()
        plt.close()
        ...
        plt.colorbar()
        plt.title('J2140_' + 'pixnoise_' + 'F160W (maybe)')
        pdf.savefig()
        plt.close()
        ...
        plt.colorbar()
        plt.title(galaxies[w].name + 'pixNoise' + 'F475W (maybe)')
        pdf.savefig()
        plt.close()
        ...
        plt.colorbar()
        plt.title('J2140 Pixnoise Galfit Sigma Ratio for F475W (maybe)')
        pdf.savefig()
        plt.close()
        ...
        plt.colorbar()
        plt.title('J2140 Pixnoise Galfit Sigma Ratio for F814W (maybe)')
        pdf.savefig()
        plt.close()
        ...
        plt.colorbar()
        plt.title('J2140 Pixnoise Galfit Sigma Ratio for F160W (maybe)')
        pdf.savefig()
        plt.close()
