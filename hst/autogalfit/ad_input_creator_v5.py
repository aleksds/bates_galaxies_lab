...
#SIMULTANEOUS FITS OF VARYING DEGREE
    ...
    for w in range(0,ngal):
        ...
        for q in range(0,nre):
            ...
            text.write('#  Chi^2/nu = ,  Chi^2 = ,  Ndof = \n') #probably not essential
            text.write('# IMAGE and GALFIT CONTROL PARAMETERS\n') #will not change , probably not essential
            text.write('A) /Users/adiamond/physics/linux-lab/data/hst/'+longgal[w]+'/'+plate+'/'+filters[1]+'/final_'+filters[1]+'_drc_sci.fits,/Users/adiamond/physics/linux-lab/data/hst/'+longgal[w]+'/'+plate+'/'+filters[0]+'/final_'+filters[0]+'_drc_sci.fits,/Users/adiamond/physics/linux-lab/data/hst/'+longgal[w]+'/'+plate+'/'+filters[2]+'/final_'+filters[2]+'_drz_sci.fits\n')
            text.write('A1) V,U,J\n')
            text.write('A2) 814.000,475.000,160.000\n')
            #text.write('B) '+galaxies[w]+'_F814W_F475W_F160W_'+model+'_output.fits\n')
            text.write('B) '+galaxies[w]+'_F814W_F475W_F160W_'+model+'_effective_re'+str(q)+'_output.fits\n')
            text.write('C) none,none,none      0.000\n')
            text.write('D) /Users/adiamond/physics/linux-lab/data/hst/'+longgal[w]+'/'+psf+'/'+filters[1]+'/final_psf.fits,/Users/adiamond/physics/linux-lab/data/hst/'+longgal[w]+'/'+psf+'/'+filters[0]+'/final_psf.fits,/Users/adiamond/physics/linux-lab/data/hst/'+longgal[w]+'/'+psf+'/'+filters[2]+'/final_psf.fits\n')
            ...
            if model == 'sersic':
                ...
                text.write(' 4) '+str(tmp[w][q]/2)+','+str(tmp[w][q]/2)+','+str(tmp[w][q]/2)+'    1,0,0                band\n')
