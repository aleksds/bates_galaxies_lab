...
# run bgl_input_magmag.py sersic fine 200 fine simultaneous s_index
        ...
        for j in range(0, nmag):
            ...
            for q in range(0, nmag):
                ...
                if model == 'sersic':
                    ...
                    constraint_text.write('1              re         '\
                        +str(bgl_values['re'][w])+' to '+str(bgl_values['re'][w])+' \n')                    
                ...
                if model == 'sersic':
                    ...
                    text.write(' 4)  '+str(bgl_values['re'][w])+',0    1,0                 cheb\n')
