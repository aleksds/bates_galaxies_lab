...
# 6. for galaxy J1107, measure flux, color, luminosity, mass-to-light ratio and mass for each annulus
# 7. make plots of spatially-resolved mass vs. radius and spatially-integrated mass vs. radius for J1107
...
with PdfPages('jr_overlays_J1107.pdf') as pdf:
    ...
    plt.title('J1107 Mass vs. Radius, annular M/L ratios',fontsize=16)
    plt.tight_layout()
    ...
    os.system('open %s &' % 'jr_overlays_J1107.pdf')
