...
# match to the galaxy you want
        match = table.field('Galaxy') == table["Galaxy"][i]
...
# create a photometry dictionary
        ...
        plt.title(table["Galaxy"][i])

        #Adds vertical errorbars
        plt.errorbar(wave, f_gal, yerr=uncert, xerr=None)
        #print(uncert/flux*100)
        ...
        #for loop that goes through the 12 galaxies and saves them in a file
        #for x in 'Galaxy':run
