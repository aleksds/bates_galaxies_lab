...
with PdfPages(filename) as pdf:
    ...
    plt.xlim(-16, -24)
    plt.ylim(1,8)
    plt.scatter(iabs_gal, nuv_i_gal, color='lightsteelblue', label= 'All MPL-7 galaxies', s=5, alpha = 1.0)
    plt.xlabel('i-band')
    plt.ylabel('NUV-i')
    ...
    plt.xlim(-16, -24)
    plt.ylim(1,8)
    plt.scatter(iabs_gal_late, nuv_i_gal_late, color='cyan', label= 'Late-type Galaxies', s=5, marker= '^', alpha = 1.0)
    plt.xlabel('i-band')
    plt.ylabel('NUV-i')
    ...
    plt.xlim(-16, -24)
    plt.ylim(1,8)
    plt.scatter(iabs_gal_late_edge, nuv_i_gal_late_edge, color='navy', label= 'Late-type-edge-on Galaxies', s=5, alpha = 1.0)
    plt.xlabel('i-band')
    plt.ylabel('NUV-i')
    ...
    plt.xlim(-16, -24)
    plt.ylim(1,8)
    plt.scatter(iabs_gal, nuv_i_gal, color='lightsteelblue', label= 'All MPL-7 galaxies', s=5, alpha = 0.5)
    plt.scatter(iabs_gal_late, nuv_i_gal_late, color='cyan', label= 'Late-type Galaxies', s=5, alpha = 0.8)
    plt.scatter(iabs_gal_late_edge, nuv_i_gal_late_edge, color='navy', label= 'Late-type-edge-on Galaxies', s=5, alpha = 1.0)
    plt.xlabel('i-band absolut')
    plt.ylabel('NUV-i')
