# Riley Theriault
# April 29, 2019
# Copied from bgl_dap_plates_mpl7
...
all_plates = [f for f in os.listdir(mpl8_dir+'HYB10-MILESHC-MILESHC/') if isdir(join(mpl8_dir+'HYB10-MILESHC-MILESHC/', f))]
print('List of plates: \n',all_plates,'\n')
plate = int(input('Please enter plate number: '))
lines = glob.glob(mpl8_dir+'HYB10-MILESHC-MILESHC/*/*/*'+ str(plate) +'*MAPS-HYB10-MILESHC-MILESHC.fits*')
filename = 'MPL8_dap_multi_'+str(plate)+'_quicklook.pdf'
...
with PdfPages(filename) as pdf:
    for i in range(0, len(lines)):
        ...
        end = name.find('-MAPS-HYB10-MILESHC-MILESHC')
        gal2 = end
        gal1 = plt2+1
