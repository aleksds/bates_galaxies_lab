...
print('there are', len(ba_gal_late_edge),'edge-on and late-type galxies in the mpl8 survey')
...
with PdfPages(filename) as pdf:
    for i in range(0,len(good_plates)):
        ...
        name = mpl8_dir + 'HYB10-MILESHC-MILESHC/' + str(plate) + '/' + str(ifu) + '/manga-' + str(plate) + '-' + str(
