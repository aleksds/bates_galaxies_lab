...
# 7. make plots of spatially-resolved mass vs. radius and spatially-integrated mass vs. radius for J0905
...
with PdfPages('jr_overlays_J0905.pdf') as pdf:
    ...
    plt.ylabel('Mass (solar masses)',fontsize=14)
    plt.tight_layout()
    plt.title('J0905 Mass vs. Radius, M_SRC and M_SIC',fontsize=15)
    ...
    plt.tight_layout()
    plt.title('J0905 Mass Density vs. Radius, M_SRC and M_SIC',fontsize=15)
    legend = bx.legend(loc='upper right')
    ...
    os.system('open %s &' % 'jr_overlays_J0905.pdf')
